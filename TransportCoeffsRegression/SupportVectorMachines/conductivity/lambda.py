...
# Plot dataset
#plt.scatter(dataset[:,1], dataset[:,4], s=0.5)
#plt.title('Thermal condcutivity')
#plt.xlabel('T [K]')
...
#plt.title('Thermal conductivity regression with SVR')
plt.ylabel(r'$\lambda$ [W/(m·K)]')
plt.xlabel('T [K]')
plt.legend()
plt.tight_layout()
plt.savefig("lambda_SVR.pdf", dpi=150, crop='false')
plt.savefig("lambda_SVR.eps", dpi=150, crop='false')
plt.show()
