...
#from sklearn.gaussian_process import Gaussian ProcessRegressor
...
kn = KNeighborsRegressor(n_neighbors=best_n_neighbors, algorithm=best_algorithm, leaf_size=best_leaf_size, weights=best_weights,
                         p=best_p)
