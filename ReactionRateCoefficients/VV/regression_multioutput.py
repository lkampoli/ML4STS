...
dataset=np.loadtxt("./data/VV_DOWN_N2_0-1.csv")
#dataset=np.loadtxt("./data/VV_DOWN_N2_1-2.csv")
#dataset=np.loadtxt("./data/VV_DOWN_N2_45-46.csv")
#dataset=np.loadtxt("./data/VV_DOWN_N2_all.csv")
...
dump(sc_x, open('scaler_x_down_0-1.pkl', 'wb'))
dump(sc_y, open('scaler_y_down_0-1.pkl', 'wb'))
...
plt.legend()
plt.tight_layout()
plt.savefig("regression_MO_kNN_VV_down_0-1.pdf", dpi=150, crop='false')
plt.show()

# save the model to disk
dump(regr, 'model_MO_kNN_VV_down_0-1.sav')
