...
regr = KernelRidge(kernel='rbf', gamma=100, alpha=0.0)
...
plt.scatter(x_test_dim, y_regr_dim[:,10], s=2, c='r', marker='+', label='KernelRidge, i=10')

plt.scatter(x_test_dim, y_test_dim[:,20], s=2, c='k', marker='o', label='Matlab')
plt.scatter(x_test_dim, y_regr_dim[:,20], s=2, c='g', marker='+', label='KernelRidge, i=20')

plt.scatter(x_test_dim, y_test_dim[:,30], s=2, c='k', marker='o', label='Matlab')
plt.scatter(x_test_dim, y_regr_dim[:,30], s=2, c='b', marker='+', label='KernelRidge, i=30')

plt.scatter(x_test_dim, y_test_dim[:,40], s=2, c='k', marker='o', label='Matlab')
plt.scatter(x_test_dim, y_regr_dim[:,40], s=2, c='m', marker='+', label='KernelRidge, i=40')
