...
regr = DecisionTreeRegressor(max_features='auto',
                             criterion='mse',
                             splitter='best',
                             random_state=69)
...
#plt.scatter(x_DR_test_dim, y_DR_test_dim[:,5], s=8, c='k', marker='o', label='Matlab')
#plt.scatter(x_DR_test_dim, y_DR_regr_dim[:,5], s=8, c='r', marker='x', label='DecisionTree, DR, i=5')
#
#plt.scatter(x_VT_test_dim, y_VT_test_dim[:,5], s=8, c='k', marker='o', label='Matlab')
#plt.scatter(x_VT_test_dim, y_VT_regr_dim[:,5], s=8, c='g', marker='x', label='DecisionTree, VT, i=5')
#
#plt.scatter(x_VV_test_dim, y_VV_test_dim[:,5], s=8, c='k', marker='o', label='Matlab')
#plt.scatter(x_VV_test_dim, y_VV_regr_dim[:,5], s=8, c='b', marker='x', label='DecisionTree, VV, i=5')
#
#plt.scatter(x_DR_test_dim, y_DR_test_dim[:,10], s=8, c='k', marker='o', label='Matlab')
#plt.scatter(x_DR_test_dim, y_DR_regr_dim[:,10], s=8, c='r', marker='+', label='DecisionTree, DR, i=10')
#
#plt.scatter(x_VT_test_dim, y_VT_test_dim[:,10], s=8, c='k', marker='o', label='Matlab')
#plt.scatter(x_VT_test_dim, y_VT_regr_dim[:,10], s=8, c='g', marker='+', label='DecisionTree, VT, i=10')
#
#plt.scatter(x_VV_test_dim, y_VV_test_dim[:,10], s=8, c='k', marker='o', label='Matlab')
#plt.scatter(x_VV_test_dim, y_VV_regr_dim[:,10], s=8, c='b', marker='+', label='DecisionTree, VV, i=10')

mf = 4
plt.scatter(x_DR_test_dim, y_DR_test_dim[:,20], s=8*mf, c='k', marker='o', label='Matlab')
plt.scatter(x_DR_test_dim, y_DR_regr_dim[:,20], s=8*mf, marker='*', label='DecisionTree, DR, i=20', facecolors='none', edgecolors='r')

plt.scatter(x_VT_test_dim, y_VT_test_dim[:,20], s=8*mf, c='k', marker='o') #label='Matlab')
plt.scatter(x_VT_test_dim, y_VT_regr_dim[:,20], s=8*mf, marker='*', label='DecisionTree, VT, i=20', facecolors='none', edgecolors='g')

plt.scatter(x_VV_test_dim, y_VV_test_dim[:,20], s=8*mf, c='k', marker='o') #label='Matlab')
plt.scatter(x_VV_test_dim, y_VV_regr_dim[:,20], s=8*mf, marker='*', label='DecisionTree, VV, i=20', facecolors='none', edgecolors='b')

plt.scatter(x_DR_test_dim, y_DR_test_dim[:,30], s=8*mf, c='k', marker='o')  #label='Matlab')
plt.scatter(x_DR_test_dim, y_DR_regr_dim[:,30], s=8*mf, marker='^', label='DecisionTree, DR, i=30', facecolors='none', edgecolors='r')

plt.scatter(x_VT_test_dim, y_VT_test_dim[:,30], s=8*mf, c='k', marker='o') #label='Matlab')
plt.scatter(x_VT_test_dim, y_VT_regr_dim[:,30], s=8*mf, marker='^', label='DecisionTree, VT, i=30', facecolors='none', edgecolors='g')

plt.scatter(x_VV_test_dim, y_VV_test_dim[:,30], s=8*mf, c='k', marker='o') #label='Matlab')
plt.scatter(x_VV_test_dim, y_VV_regr_dim[:,30], s=8*mf, marker='^', label='DecisionTree, VV, i=30', facecolors='none', edgecolors='b')

plt.scatter(x_DR_test_dim, y_DR_test_dim[:,40], s=8*mf, c='k', marker='o') #label='Matlab')
plt.scatter(x_DR_test_dim, y_DR_regr_dim[:,40], s=8*mf, marker='X', label='DecisionTree, DR, i=40', facecolors='none', edgecolors='r')

plt.scatter(x_VT_test_dim, y_VT_test_dim[:,40], s=8*mf, c='k', marker='o') #label='Matlab')
plt.scatter(x_VT_test_dim, y_VT_regr_dim[:,40], s=8*mf, marker='X', label='DecisionTree, VT, i=40', facecolors='none', edgecolors='g')

plt.scatter(x_VV_test_dim, y_VV_test_dim[:,40], s=8*mf, c='k', marker='o') #label='Matlab')
plt.scatter(x_VV_test_dim, y_VV_regr_dim[:,40], s=8*mf, marker='X', label='DecisionTree, VV, i=40', facecolors='none', edgecolors='b')
...
plt.tight_layout()
#plt.savefig("regression_MO_DT_DR_VT_VV.eps", dpi=150, crop='false')
plt.savefig("regression_MO_DT_DR_VT_VV.pdf", dpi=150, crop='false')
plt.show()

# save the model to disk
#dump(regr, 'model_MO_DT_DR_VT_VV.sav')
