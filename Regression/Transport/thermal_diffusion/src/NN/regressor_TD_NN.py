...
model = Sequential()
model.add(Dense(61, input_dim=in_dim, kernel_initializer='normal', activation='relu'))
model.add(Dense(124, activation='relu'))
#model.add(Dense(868, input_dim=in_dim, kernel_initializer='normal', activation='relu'))
#model.add(Dense(744, activation='relu'))
