function [RDn2, RDo2, RDno, RZn2, RZo2, RZno, RVTn2, RVTo2, RVTno, RVVn2, RVVo2, RVVno] = rpart_fho_post(y)
...
RDn2 = RDn2' * n0*v0/Delta;
RDo2 = RDo2' * n0*v0/Delta;
RDno = RDno' * n0*v0/Delta;

RZn2 = RZn2' * n0*v0/Delta;
RZo2 = RZo2' * n0*v0/Delta;
RZno = RZno' * n0*v0/Delta;

RVTn2 = RVTn2' * n0*v0/Delta;
RVTo2 = RVTo2' * n0*v0/Delta;
RVTno = RVTno' * n0*v0/Delta;

RVVn2 = RVVn2' * n0*v0/Delta;
RVVo2 = RVVo2' * n0*v0/Delta;
RVVno = RVVno' * n0*v0/Delta;
