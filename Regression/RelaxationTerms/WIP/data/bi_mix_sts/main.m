...
disp(['energy = ',num2str(d3)]);
 ...
 movefile solution_bi_mix_sts_x_s_time_s_Temp_rho_p_v_E_ni_n_na_n_RD_mol_RD_at.dat ..

 dataset = [x_s, time_s, Temp, rho, p, v, E, ni_n, na_n, RVT];
 save solution_bi_mix_sts_x_s_time_s_Temp_rho_p_v_E_ni_n_na_n_RVT.dat          dataset -ascii
 movefile solution_bi_mix_sts_x_s_time_s_Temp_rho_p_v_E_ni_n_na_n_RVT.dat ..

 dataset = [x_s, time_s, Temp, rho, p, v, E, ni_n, na_n, RVV];
