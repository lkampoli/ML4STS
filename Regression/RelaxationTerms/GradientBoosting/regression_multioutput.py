...
plt.scatter(x_test_dim, y_regr_dim[:,10], s=2, c='r', marker='+', label='GradientBoosting, i=10')

plt.scatter(x_test_dim, y_test_dim[:,20], s=2, c='k', marker='o', label='Matlab')
plt.scatter(x_test_dim, y_regr_dim[:,20], s=2, c='g', marker='+', label='GradientBoosting, i=20')

plt.scatter(x_test_dim, y_test_dim[:,30], s=2, c='k', marker='o', label='Matlab')
plt.scatter(x_test_dim, y_regr_dim[:,30], s=2, c='b', marker='+', label='GradientBoosting, i=30')

plt.scatter(x_test_dim, y_test_dim[:,40], s=2, c='k', marker='o', label='Matlab')
plt.scatter(x_test_dim, y_regr_dim[:,40], s=2, c='m', marker='+', label='GradientBoosting, i=40')
...
plt.legend()
plt.tight_layout()
#plt.savefig("regression_MO_GB_DR.eps", dpi=150, crop='false')
#plt.savefig("regression_MO_GB_DR.pdf", dpi=150, crop='false')
#plt.savefig("regression_MO_GB_VT.eps", dpi=150, crop='false')
#plt.savefig("regression_MO_GB_VT.pdf", dpi=150, crop='false')
plt.savefig("regression_MO_GB_VV.eps", dpi=150, crop='false')
plt.savefig("regression_MO_GB_VV.pdf", dpi=150, crop='false')
plt.show()
