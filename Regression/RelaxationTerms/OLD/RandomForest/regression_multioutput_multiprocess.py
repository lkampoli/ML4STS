...
plt.scatter(x_DR_test_dim, y_DR_regr_dim[:,10], s=8, c='r', marker='+', label='RandomForest, DR, i=10')

plt.scatter(x_VT_test_dim, y_VT_test_dim[:,10], s=8, c='k', marker='o', label='Matlab')
plt.scatter(x_VT_test_dim, y_VT_regr_dim[:,10], s=8, c='g', marker='+', label='RandomForest, VT, i=10')

plt.scatter(x_VV_test_dim, y_VV_test_dim[:,10], s=8, c='k', marker='o', label='Matlab')
plt.scatter(x_VV_test_dim, y_VV_regr_dim[:,10], s=8, c='b', marker='+', label='RandomForest, VV, i=10')

plt.scatter(x_DR_test_dim, y_DR_test_dim[:,20], s=8, c='k', marker='o', label='Matlab')
plt.scatter(x_DR_test_dim, y_DR_regr_dim[:,20], s=8, c='r', marker='*', label='RandomForest, DR, i=20')

plt.scatter(x_VT_test_dim, y_VT_test_dim[:,20], s=8, c='k', marker='o', label='Matlab')
plt.scatter(x_VT_test_dim, y_VT_regr_dim[:,20], s=8, c='g', marker='*', label='RandomForest, VT, i=20')

plt.scatter(x_VV_test_dim, y_VV_test_dim[:,20], s=8, c='k', marker='o', label='Matlab')
plt.scatter(x_VV_test_dim, y_VV_regr_dim[:,20], s=8, c='b', marker='*', label='RandomForest, VV, i=20')

plt.scatter(x_DR_test_dim, y_DR_test_dim[:,30], s=8, c='k', marker='o', label='Matlab')
plt.scatter(x_DR_test_dim, y_DR_regr_dim[:,30], s=8, c='r', marker='^', label='RandomForest, DR, i=30')

plt.scatter(x_VT_test_dim, y_VT_test_dim[:,30], s=8, c='k', marker='o', label='Matlab')
plt.scatter(x_VT_test_dim, y_VT_regr_dim[:,30], s=8, c='g', marker='^', label='RandomForest, VT, i=30')

plt.scatter(x_VV_test_dim, y_VV_test_dim[:,30], s=8, c='k', marker='o', label='Matlab')
plt.scatter(x_VV_test_dim, y_VV_regr_dim[:,30], s=8, c='b', marker='^', label='RandomForest, VV, i=30')

plt.scatter(x_DR_test_dim, y_DR_test_dim[:,40], s=8, c='k', marker='o', label='Matlab')
plt.scatter(x_DR_test_dim, y_DR_regr_dim[:,40], s=8, c='r', marker='X', label='RandomForest, DR, i=40')

plt.scatter(x_VT_test_dim, y_VT_test_dim[:,40], s=8, c='k', marker='o', label='Matlab')
plt.scatter(x_VT_test_dim, y_VT_regr_dim[:,40], s=8, c='g', marker='X', label='RandomForest, VT, i=40')

plt.scatter(x_VV_test_dim, y_VV_test_dim[:,40], s=8, c='k', marker='o', label='Matlab')
plt.scatter(x_VV_test_dim, y_VV_regr_dim[:,40], s=8, c='b', marker='X', label='RandomForest, VV, i=40')
...
plt.savefig("regression_MO_RF_DR_VT_VV.pdf", dpi=150, crop='false')
plt.show()
