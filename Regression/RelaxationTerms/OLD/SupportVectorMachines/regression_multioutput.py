...
plt.legend()
plt.tight_layout()
#plt.savefig("regression_MO_SVR_DR.eps", dpi=150, crop='false')
#plt.savefig("regression_MO_SVR_DR.pdf", dpi=150, crop='false')
#plt.savefig("regression_MO_SVR_VT.eps", dpi=150, crop='false')
#plt.savefig("regression_MO_SVR_VT.pdf", dpi=150, crop='false')
plt.savefig("regression_MO_SVR_VV.eps", dpi=150, crop='false')
plt.savefig("regression_MO_SVR_VV.pdf", dpi=150, crop='false')
plt.show()
