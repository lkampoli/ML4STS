...
plt.scatter(x_test_dim[:,2], y_test_dim[:,3], s=2, c='k', marker='o', label=r'$\Omega_{N_{2}-N_{2}}^{1,1}$ -- KAPPA')
plt.scatter(x_test_dim[:,2], y_regr_dim[:,3], s=2, c='r', marker='+', label=r'$\Omega_{N_{2}-N_{2}}^{1,1}$ -- ExtraTrees')
#
plt.scatter(x_test_dim[:,2], y_test_dim[:,4], s=2, c='k', marker='o', label=r'$\Omega_{N_{2}-N_{2}}^{1,2}$ -- KAPPA')
plt.scatter(x_test_dim[:,2], y_regr_dim[:,4], s=2, c='b', marker='+', label=r'$\Omega_{N_{2}-N_{2}}^{1,2}$ -- ExtraTrees')
#
plt.scatter(x_test_dim[:,2], y_test_dim[:,5], s=2, c='k', marker='o', label=r'$\Omega_{N_{2}-N_{2}}^{1,3}$ -- KAPPA')
plt.scatter(x_test_dim[:,2], y_regr_dim[:,5], s=2, c='g', marker='+', label=r'$\Omega_{N_{2}-N_{2}}^{1,3}$ -- ExtraTrees')
#
plt.scatter(x_test_dim[:,2], y_test_dim[:,6], s=2, c='k', marker='o', label=r'$\Omega_{N_{2}-N_{2}}^{2,2}$ -- KAPPA')
plt.scatter(x_test_dim[:,2], y_regr_dim[:,6], s=2, c='m', marker='+', label=r'$\Omega_{N_{2}-N_{2}}^{2,2}$ -- ExtraTrees')
#
plt.xlabel('T [K] ')
plt.legend()
plt.tight_layout()
