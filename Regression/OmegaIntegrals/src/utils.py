...
def draw_plot(x_test_dim, y_test_dim, y_regr_dim, figure, proc, algo):
    ...
    plt.scatter(x_test_dim[:,2], y_regr_dim[:,0], s=2, c='r', marker='+', label=r'$\Omega_{N_{2}-N_{2}}^{1,1}$_'+algo)
    #
    plt.scatter(x_test_dim[:,2], y_test_dim[:,1], s=2, c='k', marker='o', label=r'$\Omega_{N_{2}-N_{2}}^{1,2}$ -- KAPPA')
    plt.scatter(x_test_dim[:,2], y_regr_dim[:,1], s=2, c='b', marker='+', label=r'$\Omega_{N_{2}-N_{2}}^{1,2}$_'+algo)
    #
    plt.scatter(x_test_dim[:,2], y_test_dim[:,2], s=2, c='k', marker='o', label=r'$\Omega_{N_{2}-N_{2}}^{1,3}$ -- KAPPA')
    plt.scatter(x_test_dim[:,2], y_regr_dim[:,2], s=2, c='g', marker='+', label=r'$\Omega_{N_{2}-N_{2}}^{1,3}$_'+algo)
    #
    plt.scatter(x_test_dim[:,2], y_test_dim[:,3], s=2, c='k', marker='o', label=r'$\Omega_{N_{2}-N_{2}}^{2,2}$ -- KAPPA')
    plt.scatter(x_test_dim[:,2], y_regr_dim[:,3], s=2, c='m', marker='+', label=r'$\Omega_{N_{2}-N_{2}}^{2,2}$_'+algo)
