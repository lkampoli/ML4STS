...
dataset_T = np.loadtxt("../data/N2-N2/down/Temperatures.csv")
dataset_k = np.loadtxt("../data/N2-N2/down/VT_RATES-N2-N2-vt_down.csv")
dataset   = "VT_RATES-N2-N2-down"

Lev = sys.argv[1]

x = dataset_T.reshape(-1,1)
y = dataset_k[:,0+int(Lev):1+int(Lev)]
