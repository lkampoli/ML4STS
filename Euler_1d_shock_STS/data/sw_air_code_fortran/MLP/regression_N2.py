...
dump(sc_x, open('scaler_x_N2.pkl', 'wb'))
dump(sc_y, open('scaler_y_N2.pkl', 'wb'))
...
regr = MLPRegressor(**gs.best_params_, random_state=69)
...
with open('output_N2.log', 'w') as f:
...
plt.legend()
plt.tight_layout()
plt.savefig("regression_DT_N2.pdf", dpi=150, crop='false')
plt.show()
