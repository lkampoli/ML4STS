...
# Plot Nci
#plt.plot(x_test_sb, n1_pred_sb[:,1:46:2], 'o', color='black', label='NN', linewidth=2, markersize=5, fillstyle='none')
#plt.plot(x_test_sb, n1_test_sb[:,1:46:2], 'o', color='red',   label='Exact', markersize=4)
