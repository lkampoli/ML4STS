...
for i1 = 1:l
  ...
  if i1 == 1
    ...
    elseif i1 == l
      ...
      RVTm[i1] = nm_b*(ni_b[i1+1]*kvt_down[1,i1]+ni_b[i1-1]*kvt_up[1,i1-1]-ni_b[i1]*(kvt_up[1,i1]+kvt_down[1,i1-1]))
      RVTa[i1] = na_b*(ni_b[i1+1]*kvt_down[2,i1]+ni_b[i1-1]*kvt_up[2,i1-1]-ni_b[i1]*(kvt_up[2,i1]+kvt_down[2,i1-1]))
