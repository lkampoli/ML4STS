...
if __name__ == "__main__":
    ...
    [x_train,   x_test,
     ...
     Rat_train, Rat_test] = train_test_split(x, n1, n2, n3, n4, n5, n6, n7, n8, n9, n10, n11, n12, n13, n14, n15, n16, n17, n18,
                                                ...
                                                Rat, test_size=0.25, random_state=0)
...
#plt.plot(x_test_sb, n3_pred_sb, 'o', color='black', label='NN', linewidth=5, markersize=5, fillstyle='none')
#plt.plot(x_test_sb, n3_test_sb, 'o', color='red',   label='Exact', markersize=4)
#plt.plot(x_test_sb, n6_pred_sb, 'o', color='blue', label='NN', linewidth=5, markersize=5, fillstyle='none')
#plt.plot(x_test_sb, n6_test_sb, 'o', color='red',   label='Exact', markersize=4)
#plt.plot(x_test_sb, n9_pred_sb, 'o', color='green', label='NN', linewidth=5, markersize=5, fillstyle='none')
#plt.plot(x_test_sb, n9_test_sb, 'o', color='red',   label='Exact', markersize=4)
#plt.plot(x_test_sb, n12_pred_sb, 'o', color='purle', label='NN', linewidth=5, markersize=5, fillstyle='none')
#plt.plot(x_test_sb, n12_test_sb, 'o', color='red',   label='Exact', markersize=4)
#plt.plot(x_test_sb, n15_pred_sb, 'o', color='yellow', label='NN', linewidth=5, markersize=5, fillstyle='none')
#plt.plot(x_test_sb, n15_test_sb, 'o', color='red',   label='Exact', markersize=4)
