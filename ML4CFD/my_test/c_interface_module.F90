...
! few exceptions.
! 
#define C_char_ptr C_ptr
#define C_const_char_ptr C_ptr
#define C_void_ptr C_ptr
#define C_const_void_ptr C_ptr
...
!     do i = 1,length
        F_string(1:length) = p_chars(1)(1:length)
!     enddo
    end if
...
!   do i=1,strlen
      C_string(1)(1:strlen) = F_string(1:strlen)
!   enddo
...
!       do i=1,strlen
          C_string_ptr(1)(1:strlen) = F_string(1:strlen)
!       enddo
