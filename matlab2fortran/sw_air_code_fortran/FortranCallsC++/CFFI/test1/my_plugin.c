...
// 'def hello_world():\n
100,101,102,32,104,101,108,108,111,95,119,111,114,108,100,40,41,58,10,
// '    print("Hello World!")\n
32,32,32,32,112,114,105,110,116,40,34,72,101,108,108,111,32,87,111,114,108,100,
33,34,41,10,
0 };
#ifdef PYPY_VERSION
...
static struct _cffi_externpy_s _cffi_externpy__hello_world =
  { "my_plugin.hello_world", 0, 0, 0 };

CFFI_DLLEXPORT void hello_world(void)
{
  char a[8];
  char *p = a;
  _cffi_call_python(&_cffi_externpy__hello_world, p);
}

static const struct _cffi_global_s _cffi_globals[] = {
  { "hello_world", (void *)&_cffi_externpy__hello_world, _CFFI_OP(_CFFI_OP_EXTERN_PYTHON, 2), (void *)hello_world },
};
